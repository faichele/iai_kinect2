...
#include <kinect2_bridge/freenect_rgb_packet_stream_parser.h>
#include <kinect2_bridge/freenect_depth_packet_stream_parser.h>
...
#error No jpeg decoder is enabled
    ...
    const unsigned char* DumpPacketPipeline::getDepthP0Tables(size_t* length) {
        *length = sizeof(Freenect::protocol::P0TablesResponse);
