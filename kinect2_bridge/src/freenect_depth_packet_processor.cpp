...
namespace Freenect
{
    ...
    void DepthPacketProcessor::setConfiguration(const Freenect::DepthPacketProcessor::Config& config)
    {
        config_ = config;
    }

    void DepthPacketProcessor::setFrameListener(Freenect::FrameListener* listener)
    {
        listener_ = listener;
    }
