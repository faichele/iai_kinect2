...
public:
  ...
  {
    {
      Freenect::lock_guard l(packet_mutex_);
...
private:
  ...
  bool shutdown_;
  Freenect::mutex packet_mutex_; ///< Mutex indicating a new packet can be stored in #current_packet_.
  Freenect::condition_variable packet_condition_; ///< Mutex indicating processing is blocked on lack of packets.
  Freenect::thread thread_; ///< Asynchronous thread.
  ...
  void execute()
  {
    ...
    Freenect::unique_lock l(packet_mutex_);
